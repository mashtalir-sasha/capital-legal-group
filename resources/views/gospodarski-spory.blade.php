...
<head>
	<meta charset="utf-8">
	<title>{{ trans('gosp-spor.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('gosp-spor.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/gosp_spor_bg.jpg') }}">
...
<section class="receive pt scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('gosp-spor.receive_title') !!}</h3>
				<div class="row">
...
<section id="team" class="manager scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('gosp-spor.manager_title') !!}</h3>
			</div>
		</div>
...
<section class="ja_faq scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('gosp-spor.faq_title') !!}</h3>
...
<section class="service-blog scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('gosp-spor.blog_title') !!}</h3>
