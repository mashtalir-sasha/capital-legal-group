...
<head>
	<meta charset="utf-8">
	<title>{{ trans('mihratsiine-pravo.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('mihratsiine-pravo.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/mihratsiine_pravo_bg.jpg') }}">
