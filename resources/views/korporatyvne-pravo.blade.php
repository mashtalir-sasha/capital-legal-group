...
<head>
	<meta charset="utf-8">
	<title>{{ trans('korp-pravo.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('korp-pravo.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/korp_pravo_bg.jpg') }}">
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-5 col-md-6">
				<h3 class="vs_about__text">{{ Helpers::getLangString($korpAbout, 'text') }}</h3>
				<a href="#modal" class="vs_about__btn fancybox">{{ trans('korp-pravo.about_btn') }} <i></i></a>
			</div>
			<div class="col-xl-5 col-md-6">
				<div class="video-container">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/{{ basename($korpAbout->video) }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
...
<section class="other-services scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight"><span><i>{{ trans('korp-pravo.other_title') }}</i></span></h3>
				<div class="row justify-content-center">
...
<section class="ja_faq scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('korp-pravo.faq_title') !!}</h3>
...
<section class="service-blog scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('korp-pravo.blog_title') !!}</h3>
