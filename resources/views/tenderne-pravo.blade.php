...
<head>
	<meta charset="utf-8">
	<title>{{ trans('tender-pravo.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('tender-pravo.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/tenderne_pravo_bg.jpg') }}">
		...
		<div class="row justify-content-center">
			...
			<div class="col-xl-10">
				<table class="vs_price-table">
					<tr>
						<th class="first">{!! Helpers::getLangString($about, 'price_title') !!}</th>
