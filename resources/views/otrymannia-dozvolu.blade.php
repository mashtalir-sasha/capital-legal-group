...
<head>
	<meta charset="utf-8">
	<title>{{ trans('otrymannia-dozvolu.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('otrymannia-dozvolu.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/otrymannia_dozvolu_bg.jpg') }}">
...
<header class="ja_head header" style="background-image: url(/images/otrymannia_dozvolu_bg.jpg);">
	<div class="container">
		<div class="ja_head__note d-none d-xl-block">{!! trans('otrymannia-dozvolu.head_note') !!}</div>
		<div class="row align-items-center">
			<div class="col offset-lg-1">
				<div class="ja_head__content">
					<h1 class="ja_head-title">{!! trans('otrymannia-dozvolu.main_title') !!}</h1>
					<h2 class="ja_head-text">{!! trans('otrymannia-dozvolu.main_text') !!}</h2>
				</div>
			</div>
		</div>
	</div>
...
<section class="vs_about scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<div class="row">
					<div class="col-lg-4 col-sm-6">
						<div class="dozvil-item">
							<div class="dozvil-item__title">
			...
			<div class="col-12">
				<a href="#buy" class="vs_about__btn vs_about__btn_center fancybox">{{ trans('otrymannia-dozvolu.about_btn') }} <i></i></a>
			</div>
		</div>
	</div>
</section>
...
<section class="procedure scroll fadeIn">
	<div class="container">
		<div class="note d-none d-xl-block">{{ trans('otrymannia-dozvolu.procedure_note') }}</div>
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight"><span><i>{{ trans('otrymannia-dozvolu.procedure_title') }}</i></span></h3>
			</div>
			<div class="col-lg-5">
...
<section class="alt scroll fadeIn">
	<div class="container">
		<div class="note d-none d-xl-block">{{ trans('otrymannia-dozvolu.other_note') }}</div>
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('otrymannia-dozvolu.other_title') !!}</h3>
				<div class="row justify-content-center">
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/korp_alt2.jpg);">
							<p class="other-services__text">{{ trans('otrymannia-dozvolu.other_text1') }}</p>
						</div>
						<a href="{{ route('jurAut') }}" class="other-services__btn">{{ trans('otrymannia-dozvolu.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/ipn_alt2.jpg);">
							<p class="other-services__text">{{ trans('otrymannia-dozvolu.other_text2') }}</p>
						</div>
						<a href="{{ route('otrymanniaPos') }}" class="other-services__btn">{{ trans('otrymannia-dozvolu.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/ipn_alt3.jpg);">
							<p class="other-services__text">{{ trans('otrymannia-dozvolu.other_text3') }}</p>
						</div>
						<a href="{{ route('kupivliaKomp') }}" class="other-services__btn">{{ trans('otrymannia-dozvolu.other_btn') }} <i></i></a>
					</div>
				</div>
			</div>
		</div>
...
<section class="ja_faq scroll fadeIn">
	<div class="container">
		<div class="note d-none d-xl-block">{{ trans('otrymannia-dozvolu.faq_note') }}</div>
		<div class="row justify-content-center">
			<div class="col-xl-10">
...
<section class="service-blog scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('otrymannia-dozvolu.blog_title') !!}</h3>
