...
<head>
	<meta charset="utf-8">
	<title>{{ trans('podatkove-pravo.meta_title') }} | {{ trans('main.meta_title') }}</title>
	...
	<meta property="og:title" content="{{ trans('podatkove-pravo.meta_title') }} | {{ trans('main.meta_title') }}">
	<meta property="og:description" content="{{ trans('main.meta_description') }}">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ Request::url() }}">
	<meta property="og:image" content="{{ asset('images/podatkove_pravo_bg.jpg') }}">
...
<header class="ja_head header" style="background-image: url(/images/podatkove_pravo_bg.jpg);">
	<div class="container">
		<div class="ja_head__note d-none d-xl-block">{!! trans('podatkove-pravo.head_note') !!}</div>
		<div class="row align-items-center">
			<div class="col offset-lg-1">
				<div class="ja_head__content">
					<h1 class="ja_head-title">{!! trans('podatkove-pravo.main_title') !!}</h1>
					<h2 class="ja_head-subtitle">{!! trans('podatkove-pravo.main_subtitle') !!}</h2>
				</div>
			</div>
		</div>
	</div>
...
<section class="other-services scroll fadeIn">
	<div class="container">
		<div class="note d-none d-xl-block">{{ trans('podatkove-pravo.other_note') }}</div>
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight"><span><i>{{ trans('podatkove-pravo.other_title') }}</i></span></h3>
				<div class="row justify-content-center">
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod1.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text1') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod2.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text2') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod3.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text3') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod4.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text4') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod5.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text5') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="other-services__item" style="background-image: url(/images/other_pod6.jpg);">
							<p class="other-services__text">{{ trans('podatkove-pravo.other_text6') }}</p>
						</div>
						<a href="#buy" class="other-services__btn fancybox">{{ trans('podatkove-pravo.other_btn') }} <i></i></a>
					</div>
				</div>
...
<section class="ja_faq scroll fadeIn">
	<div class="container">
		<div class="note d-none d-xl-block">{{ trans('podatkove-pravo.faq_note') }}</div>
		<div class="row justify-content-center">
			<div class="col-xl-10">
...
<section class="service-blog scroll fadeIn">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title fadeInRight">{!! trans('podatkove-pravo.blog_title') !!}</h3>
