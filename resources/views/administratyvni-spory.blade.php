...
<section class="receive pt">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title">{!! trans('admin-spor.receive_title') !!}</h3>
				<div class="row">
...
<section class="manager">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title">{!! trans('admin-spor.manager_title') !!}</h3>
			</div>
		</div>
...
<section class="ja_faq">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title">{!! trans('admin-spor.faq_title') !!}</h3>
...
<section class="service-blog">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-10">
				<h3 class="ja_block-title">{!! trans('admin-spor.blog_title') !!}</h3>
