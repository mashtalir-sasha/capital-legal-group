		...
		<div class="row align-items-center">
			<div class="col offset-lg-1">
				<div class="ja_head__content">
					<h1 class="ja_head-title">{!! trans('vur-spor.main_title') !!}</h1>
					<h2 class="ja_head-text">{{ trans('vur-spor.main_text') }}</h2>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-10 offset-xl-1">
				<h3 class="vs_about__title">{{ trans('vur-spor.about_title') }}</h3>
				<ul class="vs_about-list">
					<li>{{ trans('vur-spor.about_list1') }}</li>
					<li>{{ trans('vur-spor.about_list2') }}</li>
					<li>
						{{ trans('vur-spor.about_list3') }}
						<ul class="vs_about-list_into">
							{!! trans('vur-spor.about_list3_text') !!}
						</ul>
					</li>
					<li>
						{{ trans('vur-spor.about_list4') }}
						<ul class="vs_about-list_into">
							{!! trans('vur-spor.about_list4_text') !!}
						</ul>
					</li>		
				</ul>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-xl-5 col-md-6">
				<ul class="vs_about-list">
					{!! trans('vur-spor.about_list5') !!}
				</ul>
				<a href="#modal" class="vs_about__btn fancybox">{{ trans('vur-spor.about_btn') }} <i></i></a>
			</div>
			<div class="col-xl-5 col-md-6">
			...
			<div class="col-xl-10">
				<table class="vs_price-table">
					<tr>
						<th class="first">{!! trans('vur-spor.price-table_title1') !!}</th>
						<th class="middle">{!! trans('vur-spor.price-table_title2') !!}</th>
					</tr>
					<tr>
						<td colspan="2">{{ trans('vur-spor.tarif_text') }}</td>
					</tr>
				</table>

				<p class="vs_price__last">{!! trans('vur-spor.price_last') !!}</p>
			</div>
		</div>
	</div>
</section>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<div class="receive-item">
							...
							<p class="receive-item__text">{!! trans('vur-spor.receive-item1') !!}</p>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="receive-item">
							<img src="{{ asset('images/vs_receive_ico2.svg') }}" alt="ico" class="receive-item__ico">
							<p class="receive-item__text">{!! trans('vur-spor.receive-item2') !!}</p>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="receive-item">
							<img src="{{ asset('images/vs_receive_ico3.svg') }}" alt="ico" class="receive-item__ico">
							<p class="receive-item__text">{!! trans('vur-spor.receive-item3') !!}</p>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="receive-item">
							<img src="{{ asset('images/vs_receive_ico4.svg') }}" alt="ico" class="receive-item__ico">
							<p class="receive-item__text">{!! trans('vur-spor.receive-item4') !!}</p>
						</div>
					</div>
				</div>
			</div>
...
<section class="manager">
	<div class="container">
		...
		<div class="row justify-content-center align-items-center">
			...
			<div class="col-xl-5 col-md-6">
				<p class="manager__name">{{ trans('vur-spor.manager1_name') }}</p>
				<p class="manager__position">{{ trans('vur-spor.manager1_position') }}</p>
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-xl-6 col-md-6">
				<div class="manager__content">
					...
					<p class="manager__text">{{ trans('vur-spor.manager1_text1') }}</p>
					<p class="manager__text">{{ trans('vur-spor.manager1_text2') }}</p>
				</div>
				<div class="manager__content">
					<h4 class="manager__title">{{ trans('vur-spor.manager1_title2') }}</h4>
					<p class="manager__text">{{ trans('vur-spor.manager1_text3') }}</p>
				</div>
				<div class="manager__content">
					<h4 class="manager__title">{{ trans('vur-spor.manager1_title3') }}</h4>
					<p class="manager__text">{{ trans('vur-spor.manager1_text4') }}</p>
					<p class="manager__text">{{ trans('vur-spor.manager1_text5') }}</p>
					<p class="manager__text">{{ trans('vur-spor.manager1_text6') }}</p>
				</div>
			</div>
			...
			<div class="col-xl-10">
				...
				<div class="faq-content">
					<div class="faq__title">
						<i>01</i>
						<p>{{ trans('vur-spor.question1') }}</p>
					</div>
					<div class="faq__answer">{!! trans('vur-spor.answer1') !!}</div>

					<div class="faq__title">
						<i>02</i>
						<p>{{ trans('vur-spor.question2') }}</p>
					</div>
					<div class="faq__answer">{!! trans('vur-spor.answer2') !!}</div>

					<div class="faq__title">
						<i>03</i>
						<p>{{ trans('vur-spor.question3') }}</p>
					</div>
					<div class="faq__answer">{!! trans('vur-spor.answer3') !!}</div>

					<div class="faq__title">
						<i>04</i>
						<p>{{ trans('vur-spor.question4') }}</p>
					</div>
					<div class="faq__answer">{!! trans('vur-spor.answer4') !!}</div>

					<div class="faq__title">
						<i>05</i>
						<p>{{ trans('vur-spor.question5') }}</p>
					</div>
					<div class="faq__answer">{!! trans('vur-spor.answer5') !!}</div>
				</div>
