	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-xl-5 col-md-6">
				<ul class="vs_about-list">
					@if( isset($about->item5) )
						<li>
							{{ Helpers::getLangString($about, 'item5') }}
							@if( $about->list5 != '[]' )
								<ul class="vs_about-list_into">
									@foreach( json_decode($about->list5) as $item )
										@if( app()->getLocale() == 'uk')
											<li>{{ $item->item }}</li>
										@else
											<li>{{ $item->itemRU }}</li>
					...
					@if( isset($about->item6) )
						<li>
							{{ Helpers::getLangString($about, 'item6') }}
							@if( $about->list6 != '[]' )
								<ul class="vs_about-list_into">
									@foreach( json_decode($about->list6) as $item )
										@if( app()->getLocale() == 'uk')
											<li>{{ $item->item }}</li>
										@else
											<li>{{ $item->itemRU }}</li>
			...
			<div class="col-xl-10">
				<table class="vs_price-table">
					...
					<tr>
						<td colspan="2">{{ Helpers::getLangString($about, 'price_text') }}</td>
					</tr>
				</table>
